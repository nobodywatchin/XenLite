...
dnf install -y avahi cockpit cockpit-machines cockpit-files libvirt tmux vim firewalld

# NOTE: STILL MISSING XEN TOOLS!

# DOCKER IS COMMENTED OUT, NEED TO STRIP THE IMAGE DOWN TOO
